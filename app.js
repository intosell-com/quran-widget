(() => {
  ...
  const iframeCode = `<iframe src="${base}embed.html" style="width:100%;max-width:900px;height:470px;border:0;border-radius:34px;overflow:hidden" loading="lazy"></iframe>`;
